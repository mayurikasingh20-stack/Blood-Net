              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/50">
                    <th className="text-left px-3 py-3 text-xs font-bold text-slate-500 uppercase">Name</th>
                    <th className="text-left px-3 py-3 text-xs font-bold text-slate-500 uppercase">License ID</th>
                    <th className="text-left px-3 py-3 text-xs font-bold text-slate-500 uppercase hidden md:table-cell">Contact</th>
                    <th className="text-left px-3 py-3 text-xs font-bold text-slate-500 uppercase hidden lg:table-cell">City</th>
                    <th className="text-left px-3 py-3 text-xs font-bold text-slate-500 uppercase">Status</th>
                    <th className="text-right px-3 py-3 text-xs font-bold text-slate-500 uppercase">Actions</th>
                  </tr>
                </thead>
                  ...
                  {filteredBanks.map((b) => {
                    ...
                    return (
                      <tr key={b.id} className="hover:bg-slate-50/50 transition">
                        ...
                        <td className="px-3 py-3 text-slate-600 font-mono text-xs">{b.license_id || "—"}</td>
                        <td className="px-3 py-3 text-slate-500 hidden md:table-cell">{b.contact_person || "—"}</td>
                        <td className="px-3 py-3 text-slate-500 hidden lg:table-cell">{b.city || "—"}</td>
                        <td className="px-3 py-3">
                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
