    ...
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50 px-4">
      <div className="bg-white rounded-2xl w-full max-w-md p-7">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            <div className="bg-red/10 p-3 rounded-full">
              <Heart className="text-red" size={22} />
            </div>
            <div>
              <h2 className="font-semibold text-lg">Confirm Donation</h2>
              <p className="text-sm text-slate-500">Please read before accepting.</p>
            </div>
          </div>
        ...
        <div className="flex gap-3 mt-7">
          <button onClick={onClose} disabled={confirming} className="flex-1 border border-slate-200 rounded-full py-3 font-semibold disabled:opacity-50">
            Cancel
          </button>
          <button
