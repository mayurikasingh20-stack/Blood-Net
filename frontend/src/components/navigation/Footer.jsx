      ...
      <footer className={`w-full py-6 border-t border-slate-100 mt-8 bg-white ${className}`}>
        <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-8 gap-3 max-w-6xl mx-auto">
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-red-500 to-[#7F1D1D] flex items-center justify-center shadow-sm shadow-red/20">
          ...
          <div className="flex gap-5">
            <Link className="text-xs text-slate-400 hover:text-[#7F1D1D] transition" to="#">Privacy Policy</Link>
            <Link className="text-xs text-slate-400 hover:text-[#7F1D1D] transition" to="#">Terms of Service</Link>
            <Link className="text-xs text-slate-400 hover:text-[#7F1D1D] transition" to="#">Contact</Link>
          </div>
        </div>
      </footer>
    );
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-5 mb-6">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-red-500 to-[#7F1D1D] flex items-center justify-center shadow-sm shadow-red/20">
          ...
          <div className="flex flex-wrap gap-6">
            {links.map((link) => (
              <Link
                key={link.to}
                to={link.to}
                className="text-xs text-slate-400 hover:text-[#7F1D1D] transition"
              >
                {link.label}
              </Link>
            ))}
